...
if (_faction == 2) then {
	...
	_InfPool   = ["I_Soldier_A_F","I_Officer_F","I_Soldier_AR_F","I_Soldier_AT_F","I_Soldier_exp_F","I_soldier_F"];
...
if (_faction == 5) then {
	...
	_shipPool  = [];
	_diverPool = ["LOP_IRA_Infantry_Driver"];
	_crewPool  = ["LOP_IRA_Infantry_Driver"];
	_heliCrew  = ["LOP_IRA_Infantry_Driver"];
 };
...
if (_faction == 6) then {
	...
	_stPool    = [];
	_shipPool  = [];
	_diverPool = ["rhs_msv_armoredcrew"];
	_crewPool  = ["rhs_vdv_machinegunner","rhs_vdv_rifleman","rhs_vdv_rifleman","rhs_vdv_rifleman","rhs_vdv_rifleman","rhs_vdv_rifleman","rhs_vdv_rifleman","rhs_vdv_rifleman"];
	_heliCrew  = ["rhs_vdv_officer"];
};
