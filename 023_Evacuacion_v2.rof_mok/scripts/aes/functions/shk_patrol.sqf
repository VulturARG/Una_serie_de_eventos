...
private["_wp", "_mPos", "_mkrX", "_mkrY", "_mkrSize"];
_dst = 250;
...
if (IsVCOM_MOD) then {
    _wp = [_grp, _marker, "random"] call AES_fnc_setNewWaypoint;
    ...
    _wp setWaypointStatements["true", "[_grp, _mPos, _mkrSize] call BIS_fnc_taskPatrol;"];
} else {
