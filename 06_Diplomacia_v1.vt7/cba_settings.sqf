...
force VCM_HEARINGDISTANCE = 250; //Distancia AI escucha disparos no suprimidos.
force VCM_MINECHANCE = 05; //Probabilidad de poner una mina
...
force VCM_WARNDIST = 300; //Hasta qué distancia la AI puede solicitar ayuda de otros grupos.
