...
TEMPLATE_VERSION     = "0.9.17";
TEMPLATE_LAST_UPDATE = "2020-1-9";                // Escribir la fecha en formato AAAA-M-D sin ceros en el mes o el día.
...
FPS_MAP = 1;                                        // 1: Muestra fps en mapa del servidor y los headless client, 0: Deshabilita.
