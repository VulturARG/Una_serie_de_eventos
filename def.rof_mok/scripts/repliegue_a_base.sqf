...
_text = format["%1<t color='#ffffff' size = '.6'>El puesto INDIA BRAVO a caido</t><br/>",_text];
_text = format["%1<t color='#ffffff' size = '.6'>Redespliegue inmediatamente a la posición MIKE TANGO</t><br/>",_text];
