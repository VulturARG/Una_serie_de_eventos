...
force VCM_HEARINGDISTANCE = 700; //Distancia AI escucha disparos no suprimidos.
...
force VCM_WARNDIST = 500; //Hasta qué distancia la AI puede solicitar ayuda de otros grupos.
