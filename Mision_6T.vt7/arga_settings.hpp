...
OBJETIVOS = ["Relevar las tropas de seguridad de los diplomáticos en torno al edificio de reunión en Cruce Bravo.", "Relevar las tropas en los Cruces Alfa y Charlie.","Reglas de Combate:","No disparar sin provocación previa.","Sólo traspasar la frontera en el punto Bravo sin salir de los complejos de cruce internacional.", "Apresar a cualquier civil que transgreda la zona de seguridad fronteriza y entregarlo a las fuerzas locales."];
